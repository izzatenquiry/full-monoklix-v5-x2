...
const VoiceStudioView: React.FC<VoiceStudioViewProps> = ({ language }) => {
    ...
    useEffect(() => {
        try {
            const stateToSave = { script, actor, mood };
    ...
    const handleGenerate = useCallback(async () => {
        ...
        try {
            ...
            const blob = await generateVoiceOver(script, actor, language, mood);
    ...
    const leftPanel = (
        <>
            ...
            <Section title="Write Your Script">
                <textarea
                    value={script}
